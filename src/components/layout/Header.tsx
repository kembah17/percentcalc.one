        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {tools.slice(0, 4).map((tool) => (
              ...
              >
                {tool.name.replace(" Calculator", "").replace(" Converter", "")}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={toggleDark}
              className="relative w-14 h-7 rounded-full bg-surface-alt dark:bg-surface-dark-alt border border-border dark:border-border-dark transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <button
              ...
              className="md:hidden p-2 text-text dark:text-text-dark"
